...
public class ConfigManager {
    ...
    private void initializeDefaultPrompts() {
        ...
        promptTemplates.put("linux_files", "你是一名资深的渗透测试专家，请提供100个Linux系统中最常见的敏感文件和目录路径，用于任意文件读取漏洞测试。\n" +
                "要求：\n" +
                "1. 只输出完整的文件路径，每行一个\n" +
        ...
        promptTemplates.put("windows_files", "你是一名资深的渗透测试专家，请提供100个Windows系统中最常见的敏感文件和目录路径，用于任意文件读取漏洞测试。\n" +
                "要求：\n" +
                "1. 只输出完整的文件路径，每行一个\n" +
                "2. 包括系统配置文件、日志文件、密码文件、证书文件等\n" +
        ...
        promptTemplates.put("cn_passwords", "你是一名资深的渗透测试专家，请生成符合中国用户习惯的TOP100弱口令列表。\n" +
                "要求：\n" +
                "1. 每行一个密码\n" +
                "2. 不要包含任何解释性文字\n" +
        ...
        promptTemplates.put("upload_names", "你是一名资深的渗透测试专家，请提供100个用于文件上传漏洞测试的常见name值。\n" +
                "要求：\n" +
                "1. 每行一个name值\n" +
                "2. 不要包含任何解释性文字\n" +
        ...
        promptTemplates.put("ssrf_payloads", "你是一名资深的渗透测试专家，请提供100个用于SSRF漏洞探测的payload。\n" +
                "要求：\n" +
                "1. 每行一个payload\n" +
                "2. 不要包含任何解释性文字\n" +
        ...
        promptTemplates.put("cmd_injection", "你是一名资深的渗透测试专家，请提供100个用于命令注入漏洞探测的payload。\n" +
                "要求：\n" +
                "1. 每行一个payload\n" +
                "2. 不要包含任何解释性文字\n" +
                "3. 涵盖Windows和Linux系统\n" +
        ...
        // 添加新的提示词模板
        // SQL注入相关
        promptTemplates.put("sqli_basic", "你是一名资深的渗透测试专家，请提供100个用于SQL注入漏洞测试的基础payload。\n" +
                "要求：\n" +
                "1. 每行一个payload\n" +
                "2. 不要包含任何解释性文字\n" +
        ...
        promptTemplates.put("sqli_error", "你是一名资深的渗透测试专家，请提供100个用于SQL错误注入漏洞测试的payload。\n" +
                "要求：\n" +
                "1. 每行一个payload\n" +
                "2. 不要包含任何解释性文字\n" +
                "3. 包括各种数据库类型的错误触发语句\n" +
        ...
        promptTemplates.put("sqli_blind", "你是一名资深的渗透测试专家，请提供100个用于SQL盲注漏洞测试的payload。\n" +
                "要求：\n" +
                "1. 每行一个payload\n" +
                "2. 不要包含任何解释性文字\n" +
        ...
        promptTemplates.put("sqli_time", "你是一名资深的渗透测试专家，请提供100个用于SQL时间延迟注入漏洞测试的payload。\n" +
                "要求：\n" +
                "1. 每行一个payload\n" +
                "2. 不要包含任何解释性文字\n" +
                "3. 包括各种数据库的延时函数\n" +
        ...
        // XSS攻击相关
        promptTemplates.put("xss_reflected", "你是一名资深的渗透测试专家，请提供100个用于反射型XSS漏洞测试的payload。\n" +
                "要求：\n" +
                "1. 每行一个payload\n" +
                "2. 不要包含任何解释性文字\n" +
                "3. 包括绕过各种XSS过滤器的技巧\n" +
        ...
        promptTemplates.put("xss_stored", "你是一名资深的渗透测试专家，请提供100个用于存储型XSS漏洞测试的payload。\n" +
                "要求：\n" +
                "1. 每行一个payload\n" +
                "2. 不要包含任何解释性文字\n" +
                "3. 包括绕过各种存储安全限制的技巧\n" +
        ...
        promptTemplates.put("xss_dom", "你是一名资深的渗透测试专家，请提供100个用于DOM型XSS漏洞测试的payload。\n" +
                "要求：\n" +
                "1. 每行一个payload\n" +
                "2. 不要包含任何解释性文字\n" +
        ...
        // 目录遍历相关
        promptTemplates.put("path_traversal", "你是一名资深的渗透测试专家，请提供100个用于目录遍历漏洞测试的payload。\n" +
                "要求：\n" +
                "1. 每行一个payload\n" +
                "2. 不要包含任何解释性文字\n" +
        ...
        // XXE攻击相关
        promptTemplates.put("xxe_payloads", "你是一名资深的渗透测试专家，请提供100个用于XXE漏洞测试的payload。\n" +
                "要求：\n" +
                "1. 每行一个payload\n" +
                "2. 不要包含任何解释性文字\n" +
                "3. 包括文件读取、服务器端请求伪造等各种攻击向量\n" +
                "4. 包括绕过各种XXE保护机制的技巧\n" +
                "5. 按照有效性排序\n" +
                "6. 确保payload格式正确且实用");
        
        // NoSQL注入相关
        promptTemplates.put("nosql_injection", "你是一名资深的渗透测试专家，请提供100个用于NoSQL注入漏洞测试的payload。\n" +
                "要求：\n" +
                "1. 每行一个payload\n" +
                "2. 不要包含任何解释性文字\n" +
        ...
        // 常见用户名列表
        promptTemplates.put("common_usernames", "你是一名资深的渗透测试专家，请提供100个最常见的用户名，用于暴力破解和账号枚举测试。\n" +
                "要求：\n" +
                "1. 每行一个用户名\n" +
                "2. 不要包含任何解释性文字\n" +
        ...
        // 服务器指纹识别
        promptTemplates.put("server_fingerprinting", "你是一名资深的渗透测试专家，请提供100个用于服务器指纹识别的路径和文件。\n" +
                "要求：\n" +
                "1. 每行一个路径或文件名\n" +
                "2. 不要包含任何解释性文字\n" +
        ...
        // API参数名称
        promptTemplates.put("api_parameters", "你是一名资深的渗透测试专家，请提供100个常见的API参数名称，用于API安全测试。\n" +
                "要求：\n" +
                "1. 每行一个参数名\n" +
                "2. 不要包含任何解释性文字\n" +
                "3. 包括认证、授权相关的参数\n" +
        ...
        // 
        promptTemplates.put("java_linux_history", "你是一名资深的渗透测试专家，请根据以下某linux下的java 系统存在文件读取漏洞的数据包，结合bash_history的内容分析，提供100个常见的后渗透读取信息，用于深入安全测试\n" +
                "要求：\n" +
    ...
    private boolean loadConfigFromFile() {
        try {
            ...
            if (config.containsKey("prompt_names")) {
                ...
                promptNames.putAll(names);
            }
            
            // 读取提示词模板
            if (config.containsKey("prompts")) {
                Map<String, String> prompts = (Map<String, String>) config.get("prompts");
                promptTemplates.putAll(prompts);
            }
    ...
    private void loadConfigFromBurp() {
        try {
            // 从Burp扩展设置中加载配置
            String configJson = callbacks.loadExtensionSetting(CONFIG_FILE_NAME);
            if (configJson != null) {
                try (StringReader reader = new StringReader(configJson)) {
    ...
    private boolean saveConfigToFile() {
        try {
            ...
            apiConfig.put("api_key", getConfig(API_KEY));
            config.put("api", apiConfig);
            
            // 提示词名称
            config.put("prompt_names", promptNames);
            
            // 提示词模板
            config.put("prompts", promptTemplates);
            ...
            writer.write("# FuzzMind Configuration File\n");
            writer.write("# 此文件由FuzzMind自动生成，可以手动编辑\n\n");
    ...
    public void saveConfig() {
        try {
            ...
            properties.store(writer, "FuzzMind Configuration");
            callbacks.saveExtensionSetting(CONFIG_FILE_NAME, writer.toString());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
     ...
     */
    public void addPromptType(String key, String name, String template) {
        promptNames.put(key, name);
     ...
     * @param template 提示词模板
     */
    public void updatePromptType(String key, String name, String template) {
        promptNames.put(key, name);
        promptTemplates.put(key, template);
        saveConfig();
    }
     ...
     * @param key 提示词类型标识
     */
    public void removePromptType(String key) {
        promptNames.remove(key);
     ...
     * @param value 提示词模板
     */
    public void setPromptTemplate(String key, String value) {
        promptTemplates.put(key, value);
        saveConfig();
    }
     ...
     * @return 提示词名称
     */
    public String getPromptName(String key) {
        return promptNames.getOrDefault(key, key);
    }
